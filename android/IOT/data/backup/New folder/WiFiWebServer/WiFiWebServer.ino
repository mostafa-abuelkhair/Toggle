...
void setup() {
 ...
 pinMode(D0, OUTPUT); pinMode(D1, OUTPUT);pinMode(D2, OUTPUT);pinMode(D3, OUTPUT);pinMode(D4, OUTPUT);pinMode(D5, OUTPUT);pinMode(D6, OUTPUT);pinMode(D7, OUTPUT);//pinMode(D9, OUTPUT);pinMode(D10, OUTPUT);
   digitalWrite(D0,0);
txt[0] = 223;   
